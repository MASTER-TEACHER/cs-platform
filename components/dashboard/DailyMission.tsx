...
export default function DailyMission({ mission }: Props) {
  ...
  return (
    <Card className="border-0 bg-gradient-to-r from-indigo-600 to-blue-600 text-white">
      ...
      <p className="mt-2 text-blue-100">{mission.topic}</p>
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        ...
        <div>
          <p className="text-xs uppercase">Difficulty</p>

          <p className="mt-1 font-bold">{mission.difficulty}</p>
        </div>

        <div>
          <p className="text-xs uppercase">Time</p>

          <p className="mt-1 font-bold">{mission.estimatedTime}</p>
        </div>
      </div>
