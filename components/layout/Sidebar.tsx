...
const studentLinks: SidebarLink[] = [
  ...
  { href: "/join-school", label: "Join School", icon: "🏫" },
...
const teacherLinks: SidebarLink[] = [
  ...
  { href: "/teacher/knowledge-map", label: "Class Knowledge Map", icon: "🗺️" },
  { href: "/teacher/interventions", label: "Interventions", icon: "🧭" },
  { href: "/teacher/students", label: "Students", icon: "👨‍🎓" },
  { href: "/teacher/classes", label: "Classes", icon: "🏫" },
  { href: "/teacher/school", label: "School", icon: "🏢" },
  { href: "/teacher/assignments", label: "Assignments", icon: "📋" },
  { href: "/teacher/exam-assignments", label: "Exam Assignments", icon: "📝" },
  { href: "/teacher/assignment-wizard", label: "Assignment Wizard", icon: "🪄" },
  { href: "/teacher/quiz-generator", label: "AI Quiz Generator", icon: "🤖" },
  { href: "/teacher/quiz-library", label: "Quiz Library", icon: "🧠" },
  {
