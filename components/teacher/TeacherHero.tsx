...
export default function TeacherHero({ name }: TeacherHeroProps) {
  return (
    <Card className="border-0 bg-gradient-to-r from-emerald-700 via-teal-700 to-cyan-700 text-white">
      <p className="font-semibold text-emerald-100">👩‍🏫 Teacher Dashboard</p>

      <h1 className="mt-3 text-4xl font-extrabold">Welcome back, {name}</h1>
