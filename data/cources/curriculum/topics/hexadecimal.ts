  ...
  lessons: [
    {
      ...
      explanation:
        "Hexadecimal is a base-16 number system. It uses digits 0 to 9 and letters A to F. It is useful because it represents long binary numbers in a shorter form.",
      workedExample:
        "Binary 1111 is equal to denary 15, which is F in hexadecimal.",
      practiceQuestions: [
        {
    ...
    },
    {
      ...
      explanation:
        "Each hexadecimal digit represents four binary bits. For example, 1010 in binary is A in hexadecimal.",
      workedExample:
