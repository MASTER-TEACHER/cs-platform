...
export const curriculumDefinitions: CurriculumDefinition[] = [
   ...
   */
  {
    ...
    units: [
      ...
      },
      {
        ...
        title: "Boolean Logic",
        description: "Use logic gates, truth tables and Boolean expressions.",
   ...
   * AQA A-level
   *
   * These currently reuse compatible authored lessons.
   * Dedicated advanced A-level topics still need to be authored.
   */
  {
    ...
    units: [
      {
        ...
        title: "Programming",
        description:
          "Develop procedural, object-oriented and functional programming skills.",
        topicIds: ["programming"],
      },
      {
   ...
   */
  {
    ...
    units: [
      ...
      },
      {
        ...
        description:
          "Study operating systems, translators, programming methodologies and software development.",
        topicIds: ["systems-software", "programming"],
      },
      {
      ...
      },
      {
        ...
        description:
          "Develop advanced programming, abstraction and computational-thinking skills.",
        topicIds: ["programming", "algorithms"],
      },
      {
        id: "ocr-al-security",
